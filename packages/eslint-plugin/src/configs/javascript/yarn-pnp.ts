...
/**
 * ESLint configuration for Yarn Plug'n'Play projects.
 * - Uses the `eslint-import-resolver-pnp` resolver for import resolution.
 * - Supports both ESM (`.js`, `.mjs`) and CommonJS (`.cjs`) files.
 * - Applies different sorting rules for ESM and CJS.
 */
const yarnPnpConfig: Linter.Config[] = defineConfig([
  {
    files: ['**/*.js', '**/*.mjs'],
    extends: [
